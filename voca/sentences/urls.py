...
from .views import index, SentenceDetailView, SentenceFormsView, SentenceListView, SentenceReportView, SentenceTranslateView, UserViewSet
...
urlpatterns = [
    ...
    path('translate/', SentenceTranslateView.as_view(), name='sentence-translate'),
